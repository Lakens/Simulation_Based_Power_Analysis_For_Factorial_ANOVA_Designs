...
For most designs increasing the number of simulations to 10000, which would take a few minutes to complete, should give accurate enough results for most practical purposes.
...
The main effect for factor 'a' is the largest, and 90% power is reached with 29 participants in each conditions, while for factor 'b' 90% power is reached with 64 participants in each condition.
