...
These tools differ in their focus (e.g., sequential analyses for APRIOT, linear mixed models for PANGEA), the tests they provide power analyses for (e.g., allowing violations of the homogeneity assumption, unequal sample sizes, and power analysis for ANCOVA designs), and the input they require (e.g., effect sizes, raw data, or means, standard deviations, correlations, and sample sizes).\footnote{For a detailed overview of the functionality of different software packages, see \url{https://osf.io/9mzpn/}.}
...
Superpower can be used in R (run: \texttt{install.packages("Superpower")}) or in online Shiny apps (see \url{https://arcstats.io/shiny/anova-exact/} and \url{https://arcstats.io/shiny/anova-power/}).
...
A \texttt{2b} design means a single factor with two groups manipulated between participants, whereas a \texttt{2b*2w} design is a 2 x 2 mixed ANOVA where the first factor is manipulated between, and the second within participants.
...
For examples of ways to specify a smallest effect sizes of interest, see Lakens, Scheel, and Isager (2018).
...
The main effect for factor \enquote{a} is the largest, and 90\% power is reached with 29 participants in each condition, while for factor \enquote{b} 90\% power is reached with 64 participants in each condition.
...
Online manual: \url{https://aaroncaldwell.us/SuperpowerBook/}

ANOVA\_exact shiny app: \url{https://arcstats.io/shiny/anova-exact/}

ANOVA\_power shiny app: \url{https://arcstats.io/shiny/anova-power/}

CRAN: \url{https://CRAN.R-project.org/package=Superpower}

Github: \url{https://github.com/arcaldwell49/Superpower}
