...
Because the ANOVA\_power function relies on many simulations to determine the power for any given sample size, plotting power curves across a range of sample sizes not implemented because it is too resource intensive.
