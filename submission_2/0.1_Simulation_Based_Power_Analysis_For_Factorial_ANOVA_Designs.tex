...
\author{Dani\"{e}l Lakens\textsuperscript{1}\ \& Aaron R. Caldwell\textsuperscript{2,3}}
\affiliation{
\vspace{0.5cm}
...
Correspondence concerning this article should be addressed to Dani\textbackslash{}"\{e\}l Lakens, ATLAS 9.402, 5600 MB, Eindhoven, The Netherlands. E-mail: D.Lakens@tue.nl}
...
Delacre, M., Lakens, D., \& Leys, C. (2017). Why Psychologists Should by Default Use Welch's \emph{t}-test Instead of Student's \emph{t}-test. \emph{International Review of Social Psychology}, \emph{30}(1). \url{https://doi.org/10.5334/irsp.82}
